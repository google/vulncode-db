...
VENDOR_AND_PRODUCT_SEARCH_VARIANTS = [
    ('Vendor 1', 'Product 1', 200, {
        'count': 11
    }),
    ('Vendor 1', 'Product 10', 200, {
        'count': 0
    }),
    ('Vendor 1', '', 404, {}),
    ('Vendor 10', 'Product 1', 200, {
        'count': 1
    }),
    ('Vendor 10', 'Product 10', 200, {
        'count': 0
    }),
    ('Vendor 10', '', 404, {}),
    ('Foo', 'Product 1', 200, {
...
@pytest.mark.parametrize('cve_id, expected_code, expected_attributes',
                         VULN_INFO_VARIANTS)
def test_get_vulnerability_info_by_cve(client, cve_id, expected_code,
                                       expected_attributes):
...
@pytest.mark.parametrize('cve_id, expected_code, expected_attributes',
                         VULN_INFO_DETAILED_VARIANTS)
def test_get_vulnerability_info_details_by_cve(client, cve_id, expected_code,
                                               expected_attributes):
...
@pytest.mark.integration
@pytest.mark.parametrize('product, expected_code, expected_attributes',
                         PRDOUCT_SEARCH_VARIANTS)
def test_search_by_product(client, product, expected_code,
                           expected_attributes):
...
@pytest.mark.integration
@pytest.mark.parametrize('vendor, expected_code, expected_attributes',
                         VENDOR_SEARCH_VARIANTS)
...
@pytest.mark.integration
@pytest.mark.parametrize('vendor, product, expected_code, expected_attributes',
                         VENDOR_AND_PRODUCT_SEARCH_VARIANTS)
def test_search_by_vendor_and_product(client, vendor, product, expected_code,
                                      expected_attributes):
...
@pytest.mark.integration
@pytest.mark.parametrize('vendor_product, expected_code, expected_attributes',
                         VENDOR_OR_PRODUCT_SEARCH_VARIANTS)
def test_search_by_vendor_or_product(client, vendor_product, expected_code,
                                     expected_attributes):
...
@pytest.mark.integration
@pytest.mark.parametrize('description, expected_code, expected_attributes',
                         DESCRIPTION_SEARCH_VARIANTS)
def test_search_by_description(client, description, expected_code,
                               expected_attributes):
...
@pytest.mark.parametrize('vendor, product, expected_code, expected_attributes',
                         VENDOR_AND_PRODUCT_VARIANTS)
def test_get_by_vendor_and_product(client, vendor, product, expected_code,
                                   expected_attributes):
